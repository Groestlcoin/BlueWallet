...
import org.groestlcoin.bluewallet.components.segmentedcontrol.CustomSegmentedControlPackage
...
class MainApplication : Application(), ReactApplication {
    ...
    override fun onCreate() {
        super.onCreate()
        sharedPref = getSharedPreferences("group.org.groestlcoin.bluewallet123", Context.MODE_PRIVATE)
