...
class WidgetUpdateWorker(context: Context, workerParams: WorkerParameters) : CoroutineWorker(context, workerParams) {
    ...
    companion object {
        ...
        /**
         * Schedule periodic work for Groestlcoin Price Widget
         */
        fun scheduleWork(context: Context) {
            ...
            Log.d(TAG, "Scheduling work for Groestlcoin price widget updates, will run every $REPEAT_INTERVAL_MINUTES minutes")
        }
    ...
    override suspend fun doWork(): Result {
        ...
        Log.d(TAG, "Groestlcoin price widget update worker running")
        ...
        if (!NetworkUtils.isNetworkAvailable(applicationContext)) {
            ...
            // Update all Groestlcoin price widgets to show offline status
