...
private enum PriceIntentError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .noPriceData:
            return "No Groestlcoin price data was returned"
        case .invalidRate:
            return "Received an invalid Groestlcoin price"
        }
    }
}
...
struct PriceIntent: AppIntent {
    ...
    static let description = IntentDescription("View the current Groestlcoin market rate in your preferred currency.")
