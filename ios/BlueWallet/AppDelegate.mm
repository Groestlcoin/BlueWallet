...
- (void)showHelp:(id)sender {
  [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://groestlcoin.org/forum/"] options:@{} completionHandler:nil];
}
             ...
             withCompletionHandler:(void (^)(void))completionHandler
{
  ...
  NSString *blockExplorer = [[[NSUserDefaults standardUserDefaults] initWithSuiteName:@"group.org.groestlcoin.bluewallet123"] stringForKey:@"blockExplorer"];
