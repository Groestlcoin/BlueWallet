...
describe('Localization', () => {
  ...
  it('formatBalancePlain() && formatBalancePlain()', () => {
    _setExchangeRate('GRS_RUB', 660180.143);
    ...
    _setExchangeRate('GRS_USD', 10000);
  ...
  it.each([
    ...
    async (balance, toUnit, withFormatting, expectedResult, shouldResetRate) => {
      _setExchangeRate('GRS_USD', 1);
      _setPreferredFiatCurrency(FiatUnit.USD);
      if (shouldResetRate) {
        _setExchangeRate('GRS_USD', false);
  ...
  it.each([
    [123000000, BitcoinUnit.SATS, false, '123000000 gros'],
    [123000000, BitcoinUnit.BTC, false, '1.23 GRS'],
    [15, BitcoinUnit.BTC, false, '0.00000015 GRS'],
    [1, BitcoinUnit.BTC, false, '0.00000001 GRS'],
    [0, BitcoinUnit.BTC, false, '0 GRS'],
