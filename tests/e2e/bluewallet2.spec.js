...
describe('BlueWallet UI Tests - import BIP84 wallet', () => {
  it('can create a transaction; can scanQR with bip21; can switch units', async () => {
    ...
    await scanText('groestlcoin:grs1qnapskphjnwzw2w3dk4anpxntunc77v6q7dpwsl?amount=0.00015&pj=https://btc.donate.kukks.org/BTC/pj');
    ...
    await scanText('grs1qnapskphjnwzw2w3dk4anpxntunc77v6q7dpwsl');
